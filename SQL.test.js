...
test('SQL helper - build complex query with append', (t) => {
  ...
  t.equal(sql.pg, 'UPDATE teams SET name = $1, description = $2 WHERE id = $3 AND org_id = $4')
  t.equal(sql.sql, 'UPDATE teams SET name = ?, description = ? WHERE id = ? AND org_id = ?')
  t.equal(sql.mysql, 'UPDATE teams SET name = ?, description = ? WHERE id = ? AND org_id = ?')
...
test('SQL helper - multiline', (t) => {
  ...
  t.equal(sql.pg, 'UPDATE teams SET name = $1, description = $2\nWHERE id = $3 AND org_id = $4')
  t.equal(sql.mysql, 'UPDATE teams SET name = ?, description = ?\nWHERE id = ? AND org_id = ?')
...
test('SQL helper - build complex query with append and glue', (t) => {
  ...
  t.equal(sql.pg, 'TEST QUERY glue pieces FROM v1 = $1 , v2 = $2 , v3 = $3 , v4 = $4 , v5 = $5 WHERE v6 = $6 AND v7 = $7')
  t.equal(sql.mysql, 'TEST QUERY glue pieces FROM v1 = ? , v2 = ? , v3 = ? , v4 = ? , v5 = ? WHERE v6 = ? AND v7 = ?')
...
test('SQL helper - build complex query with append passing simple strings and template strings', (t) => {
  ...
  t.equal(sql.pg, 'TEST QUERY glue pieces FROM v1 = $1, v2 = $2, v3 = $3, v4 = $4, v5 = $5, v6 = v6 WHERE v6 = $6 AND v7 = $7 AND v8 = v8')
  t.equal(sql.mysql, 'TEST QUERY glue pieces FROM v1 = ?, v2 = ?, v3 = ?, v4 = ?, v5 = ?, v6 = v6 WHERE v6 = ? AND v7 = ? AND v8 = v8')
...
test('SQL helper - build string using append with and without unsafe flag', (t) => {
  ...
  t.equal(sql.pg, 'TEST QUERY glue pieces FROM test WHERE test1 == test2 AND v1 = v1, AND v2 = $1,  AND v3 = whateverThisIs AND v4 = v4')
  t.equal(sql.mysql, 'TEST QUERY glue pieces FROM test WHERE test1 == test2 AND v1 = v1, AND v2 = ?,  AND v3 = whateverThisIs AND v4 = v4')
...
test('SQL helper - build string using append and only unsafe', (t) => {
  ...
  t.equal(sql.pg, 'TEST QUERY glue pieces FROM test WHERE test1 == test2')
  t.equal(sql.mysql, 'TEST QUERY glue pieces FROM test WHERE test1 == test2')
  ...
  t.equal(sql.pg, 'TEST QUERY glue pieces FROM test WHERE test1 == test2 AND v1 = v1,')
  t.equal(sql.mysql, 'TEST QUERY glue pieces FROM test WHERE test1 == test2 AND v1 = v1,')
  ...
  t.equal(sql.pg, 'TEST QUERY glue pieces FROM test WHERE test1 == test2 AND v1 = v1, AND v2 = v2 AND v3 = whateverThisIs AND v4 = \'v4\'')
  t.equal(sql.mysql, 'TEST QUERY glue pieces FROM test WHERE test1 == test2 AND v1 = v1, AND v2 = v2 AND v3 = whateverThisIs AND v4 = \'v4\'')
